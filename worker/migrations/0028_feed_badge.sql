-- Aggiunge 'badge' ai tipi di post ammessi nel feed: quando un atleta completa tutte le
-- sfide di un mese e conquista il badge del mese (vedi verificaBonusMese in lib/traguardi.ts).
...
CREATE TABLE post_feed_new (
  ...
  tipo TEXT NOT NULL CHECK (
    tipo IN ('level_up', 'new_pb', 'consistency', 'athlete_of_week', 'daily_drop', 'annuncio_coach', 'sfida', 'badge')
  ),
  contenuto_url TEXT,
  testo TEXT,
